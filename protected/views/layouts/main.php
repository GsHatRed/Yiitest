...
<head>
	...
	<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl . "/static/js/popover.js",2);?>
	...
	<div class="panel panel-info online">
		...
		<div class="panel-body">
		    <ul class="online-scroll list-unstyled ps-container ps-theme-default ps-active-y" style="height: 443px;" data-ps-id="137d9bf9-205a-ad95-5cec-a529472e5734">
				...
				<li>
					<a href="<?=$data->url?>" rhref="<?=Yii::app()->createUrl('/set/info',array('id'=>$data->id))?>" rel="author" data-original-title="" title="">
