<li class="media" data-key="<?=$data->id?>">
	<a class="media-left" href="<?=$data->f_user->url?>" rel="author" data-original-title="" title="">
		<img src="<?=Profile::avatarByUserId($data->f_user_id)?>" alt="">
	</a>
	<div class="media-body">
		<h2 class="media-heading">
			<a href="<?=$data->f_user->url?>" rel="author" data-original-title="" title=""><?=User::getNameById($data->f_user_id)?></a>
		</h2>
