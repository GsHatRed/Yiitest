 ...
 */
        ...
        CKEDITOR.plugins.add('tdforms', {
            ...
            lang: 'en,zh,zh-cn',
            icons: 'tdcheckbox,tdhiddenfield,tdradio,tdselect,tdtextarea,tdtextfield,cdxdtpicker,suseranddept,listview,countersign,jsEditor,cssEditor,signature,writesign,dimensionalcode,macro,tcount,fileupload,syscode,flowcomment,calculate', // %REMOVE_LINE_CORE%
            onLoad: function() {
            ...
            init: function(editor) {
                ...
                addButtonCommand('Calculate', 'calculate', dialogPath + 'calculate.js');//计算控件
                ...
                if (editor.addMenuItems) {
                    var items = {
                        ...
                        calculate: {
                            label: lang.tdforms.calculate.dialogTitle,
                            command: 'calculate',
                            group: 'calculate'
                        }
                    };
                ...
                if (editor.contextMenu) {
                    editor.contextMenu.addListener(function(element) {
                        if (element && !element.isReadOnly()) {
                            ...
                            if (name == 'textarea' && eclass != 'calculate')
                                return {tdtextarea: CKEDITOR.TRISTATE_OFF};
                            if (name == 'textarea' && eclass == 'calculate')
                                return {calculate: CKEDITOR.TRISTATE_OFF};
                            if (name == 'input') {
                ...
                editor.on('doubleclick', function(evt) {
                    ...
                    else if (element.is('textarea') && element.getAttribute('class') != 'calculate')
                        evt.data.dialog = 'tdtextarea';
                    else if (element.is('textarea') && element.getAttribute('class') == 'calculate')
                        evt.data.dialog = 'calculate';
